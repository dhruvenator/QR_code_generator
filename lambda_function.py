...
def lambda_handler(event, context):
    try:
        body = loads(event.get('body', '{}')) if event.get('body') else event
        data = body.get('data', 'https://dhruvanarayan.com')
        error_correction_level = body.get('error_correction', 'L')
        ...
        return {
            ...
            'body': { 'qr': convert_to_list(qr_code), 'data': data }
        }
